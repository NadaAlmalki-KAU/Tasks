...
void draw(){
  ...
  // show angles
  text("Θ1: "+Math.round(Math.toDegrees(thetaA)*100.0)/100.0, 10, height-40);
  text("Θ2: "+Math.round(Math.toDegrees(thetaB)*100.0)/100.0, 10, height-20);
...
double[] inverse(double x, double y, double L1, double L2){
...
boolean isInsideCircle(double r){
